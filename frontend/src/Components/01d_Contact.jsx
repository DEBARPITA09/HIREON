      ...
      <div className={styles.layout}>
        ...
        <div className={styles.infoCol}>
          ...
          {[
            ...
            { icon: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"/><polyline points="12 6 12 12 16 14"/></svg>, label: "Hours", value: "Mon to Fri, 9am to 6pm IST" },
          ].map((item) => (
        ...
        <div className={styles.formWrap}>
          {sent ? (
            <div className={styles.successBox}>
              ...
              <button className={styles.btnPrimary} onClick={() => { setSent(false); setForm({ name:"", email:"", subject:"", message:"" }); }}>
                Send Another
              </button>
            </div>
          ) : (
            <div className={styles.form}>
              ...
              <div className={styles.group}>
                <label>Message</label>
                <textarea name="message" value={form.message} onChange={handleChange} placeholder="Describe your question or issue in detail..." rows={5} className={errors.message ? styles.inputError : ""} />
