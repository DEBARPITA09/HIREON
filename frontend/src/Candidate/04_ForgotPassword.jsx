      ...
      <div className={styles.card}>
        ...
        {!sent ? (
          <>
            ...
            <p className={styles.sub}>Enter your registered email address and we'll send you a link to reset your password.</p>
          ...
          <>
            ...
            <p className={styles.sub}>
              A password reset link has been sent to <strong className={styles.emailHighlight}>{email}</strong>.
              Click the link in your email to continue.
            </p>

            <div className={styles.emailCard}>
              <div className={styles.emailHeader}>
                <span className={styles.emailFrom}>From: noreply@hireon.io</span>
                <span className={styles.emailSubject}>Subject: Reset your HIREON password</span>
              </div>
              ...
              <button
                ...
                onClick={() => navigate("/Candidate/ResetPassword")}
              >
                Reset Password
              </button>
            </div>
